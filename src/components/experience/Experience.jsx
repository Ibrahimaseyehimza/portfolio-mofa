...
export default function Experience() {
  return (
    ...
    <section id='experience' className='relative overflow-hidden flex flex-col text-gray-600 body-font'>
        ...
        <div data-aos='fade-left' data-aos-delay='400' className='lg:flex-grow md:w-1/2 lg:pl-8 md:pl-8 flex flex-col md:items-start md:text-left items-center text-center '>
            <h1 className='title-font sm:text-4xl text-3xl mb-4 font-medium text-orange-500 '>Experience</h1>
            <h2 className='title-font font-bold text-white sm:text-2xl '>2023 - 2024 :</h2>
            <p className='mb-8 text-white leading-relaxed '>
              Introduction au designe graphique et à la communication visuel <br />
              Prise en main d'Adope photoshop, Illustrator et Figma <br />
              Bases du graphisme : couleurs, typographie, composition <br />
              Premier project pratiques (flyers, simple, retouche photo)

            </p>
            <h2 className='title-font font-bold text-white sm:text-2xl '>2024 - 2025 :</h2>
            <p className='mb-8 text-white leading-relaxed '>
              Approfondissement de Photoshop (retouche avancée, photomontage) <br />
              Création de flyers, affiches publiciaires et visuels pour réseaux sociaux <br />
              Réalisation de logos et d'identittés visuelles <br />
              Projects académiques complets avec brief
            </p>
        </div>
        </div>
    </section>
